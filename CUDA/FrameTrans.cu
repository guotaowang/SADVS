...
void FrameTrans(double *NewSM, double* Model_Trans, double * SpNum, double *MidP, double* Model_Rgb, double *Neighbor, double *Model_Lab, double *Grad_M, double *MaxDim,double *Color_Dist,double *WeightD,double *Model_Pos,double *Distance,double *ring,double *weg1,double* weg2)
{
