...
extern void ModelTransfer(double *NewSM, double* Model_Trans,double * SpNum,double *MidP,double* Model_Rgb,double *Neighbor,double *Model_Lab,double *Grad_M,double *MaxDim,double *Color_Dist,double *WeightD,double *Model_Pos,double *Distance,double *ring,double *weg1,double *weg2);
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	ModelTransfer(NewSM,Model_Trans,SpNum,MidP,Model_Rgb,Neighbor,Model_Lab,Grad_M,MaxDim,Color_Dist,WeightD,Model_Pos,Distance,ring,weg1,weg2);
}